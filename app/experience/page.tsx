...
export const metadata: Metadata = {
  title: 'Experience',
  description:
    "Costin-Alexandru Deonise's work history: Chief Technology Officer at Qflex Technologies, AI engineering at the Advanced Technology Institute and Bitdefender, and teaching at POLITEHNICA Bucharest.",
};
