...
export const featuredAwards: Award[] = [
  ...
  },
  {
    ...
    certificateImage: '/media/awards/scss-2025-impact-prize.jpg',
  },
  {
    title: "Best Scientific Master's Paper Award · Engineering Domain",
    org: 'University POLITEHNICA of Bucharest',
    year: '2025',
    certificateImage: '/media/awards/scss-2025-excellence-diploma.jpg',
  },
  {
...
export const scssPlacements: Award[] = [
  ...
  {
    title: 'Distributed Algorithms · 1st Place',
    org: 'SCSS',
    year: '2025',
    certificateImage: '/media/awards/scss-2025-first-place.jpg',
  },
  {
    title: 'Cloud/Fog/Edge Applications and Systems · 1st Place',
    org: 'SCSS',
    year: '2023',
    certificateImage: '/media/awards/scss-2023-first-place.jpg',
  },
...
export const internationalPrograms: Award[] = [
  ...
  { title: 'International Conference on Computer Vision (ICCV) · Volunteer', org: 'Paris, France', year: '2023' },
  {
    ...
    org: 'New Orleans, US',
    year: '2023',
    certificateImage: '/media/research/neurips-2023-certificate.jpg',
  },
];
